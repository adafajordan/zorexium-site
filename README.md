...
- A startup migration repairs the historical `steve` → `adafa` completed order flow, and admins can rerun legacy repair with `POST /api/admin/orders/repair-legacy`.
